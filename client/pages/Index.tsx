    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section id="securite" className="bg-white py-20 text-slate-900">
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid gap-10 md:grid-cols-2">
            <div>
              <p className="text-xs uppercase tracking-[0.5em] text-cyan-600">
                Dispositifs sûreté & sécurité
              </p>
              <h2 className="mt-3 text-3xl font-semibold text-slate-900">
                Réflexes essentiels dès la première journée
              </h2>
              <p className="mt-4 text-lg text-slate-600">
                Le module rappelle les responsabilités individuelles, les canaux
                d'escalade et les outils mis à disposition pour sécuriser notre
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-semibold">
                Validez les réflexes attendus
              </h2>
              <p className="text-slate-300">
                Les simulations de 45 secondes confirment la bonne appropriation
                des consignes et alimentent les indicateurs de conformité.
              </p>
            </div>
