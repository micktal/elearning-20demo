      ...
      <main className="mx-auto max-w-5xl px-6 pb-24 pt-20">
        <section className="rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 to-slate-950 p-10">
          <p className="text-xs uppercase tracking-[0.5em] text-cyan-200">
            Module · Codes & consignes
          </p>

          <h1 className="mt-4 text-4xl font-semibold">
            Connaître et appliquer les règles essentielles
          </h1>

          <p className="mt-4 max-w-2xl text-slate-300">
            Ces consignes sont obligatoires pour tous. Elles garantissent la
            sécurité des personnes, des données et des installations.
          </p>
          ...
          {protocols.map((protocol) => (
            ...
            >
              ...
              <p className="mt-3 text-sm text-slate-400">
                Contact référent : <strong>{protocol.contact}</strong>
              </p>
            </div>
          ))}
